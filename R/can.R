              ...
              ds <- ds %>%
                dplyr::transmute(
                  ...
                  region = dplyr::case_when(
                    ...
                    .data$region %in% c("Bathurst", "Campbellton", "Fredericton", "Miramichi", "Moncton", "Saint John") ~ "NB",
                    .data$region %in% c("St. John's") ~ "NL",
                    .data$region %in% c("Battery Point", "Bridgewater", "Dominion-Bridgeport", "Halifax", "Trenton") ~ "NS",
